...
def load_universe_financial_statements(
    *,
    ...
    """Loads SimFin statement datasets for a SimFinId universe and aligns to publish date."""
    ...
    if publish_shift_business_days < 0:
        raise ValueError("publish_shift_business_days must be a non-negative integer.")
    statements = {
